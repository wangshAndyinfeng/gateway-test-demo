...
//即时到账
var instant_trade = {"payer_identity_type":"买家标识类型，买家快捷通会员标识类型，默认1,1-快捷通会员ID,2-快捷通会员登录号",
    "payer_identity":"买家会员ID或登录账号；如没有快捷通会员ID和登录账号，则填写固定值anonymous,非空",
    ...
    "biz_product_code":"业务产品码20601-即时到帐-电商20401-即时到帐-互金20602-线下收单（支持T0退款)20701-收单（先分账后结算）,非空",
    "cashier_type":"收银台类型选择SDK收银台时，网关不会跳转到收银台页面而是返回trade_token如\"trade_token\":\"3baed917-9003-484a-9f48-9dbe3116e2f4\",非空",
...
//担保交易 1.0
//担保交易合并支付1.1
var ensure_trade = {"payer_identity_type":"买家标识类型，买家快捷通会员标识类型，默认1,1-快捷通会员ID,2-快捷通会员登录号",
    "payer_identity":"买家会员ID或登录账号；如没有快捷通会员ID和登录账号，则填写固定值anonymous,非空",
    "payer_platform_type":"买家平台类型，固定值：1",
    "payer_ip":"买家公网IP地址，用户在商户平台下单时候的ip地址，非商户服务器的ip地址，公网IP,6-32位,非空",
    "pay_method":"支付方式，根据不同的业务场景选择合适的支付方式，参考支付方式参数PayMethod",
...
var royalty_info = {"payee_identity_type":"分账标识类型，默认1，1-快捷通会员ID,2-快捷通会员登录号",
    "payee_member_id":"分账标识，分账收款方会员ID或登录号，与分账标识类型配合使用",
    "payee_account_no":"分账收款方账户号",
    "amount":"分账金额，取值范围为[0.01，100000000000.00]，精确到小数点后两位。"};
