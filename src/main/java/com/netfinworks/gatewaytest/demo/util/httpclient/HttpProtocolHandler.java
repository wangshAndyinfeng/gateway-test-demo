package com.netfinworks.gatewaytest.demo.util.httpclient;
...
public class HttpProtocolHandler {
    ...
    private static final long          defaultHttpConnectionManagerTimeout = 1000;
    ...
    public HttpResponse execute(HttpRequest request, String strParaFileName, String strFilePath)
        ...
        // 设置在ConnectionManager连接池满时的等待时间
